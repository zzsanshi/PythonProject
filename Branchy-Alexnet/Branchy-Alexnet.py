...
if __name__ == '__main__':
    ...
    traindata = datasets.CIFAR10(root='D:\Python\jupyter notebook\data', train=True, transform=transform, download=True)

    testtransform = transforms.Compose([
        transforms.CenterCrop(IMAGE_DIM),
        transforms.ToTensor(),
        transforms.Normalize((0.4914, 0.4822, 0.4465), (0.247, 0.243, 0.261))])
    testdata = datasets.CIFAR10(root='D:\Python\jupyter notebook\data', train=False, transform=testtransform, download=True)
